...
export default class Viewer extends React.Component {
 ...
 render() {
  const downloadChartAsImage = () => {
    html2canvas(document.getElementById("mermaid-chart2")).then((canvas) => {
 ...
 return(
      <div className="flex flex-column" style={{ width: '100%', height: '100%' }}>
        <div className="flex align-items-center" style={{ width: '100%', height: '100%' }}>
          <div id="mermaid-chart2" className="mermaid" style={{ width: '100%', margin: 'auto', padding: 0, paddingLeft: '10px' }} onClick={handleNodeClick}>
            {this.props.chart}
          </div>
        </div>          
